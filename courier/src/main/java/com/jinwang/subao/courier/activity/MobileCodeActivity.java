...
public class MobileCodeActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        initToolBar();
        //绑定验证码
        mobileCode=(EditText)findViewById(R.id.lfg_code);
        //绑定验证号码
        mPhoneText=(TextView)findViewById(R.id.lfg_mphone);
        Log.i(getClass().getSimpleName(),"userName"+getIntent().getStringExtra("userName"));
        mPhoneText.setText(getIntent().getStringExtra("userName"));
        //绑定发送到的验证号码
        mPhoneText=(TextView)findViewById(R.id.lfg_mphone);
        //绑定验证按钮
...
//            loadingDialog.dismiss();
    ...
    public void doRegisier(){
        ...
        params.put("Role","Group0003");
        params.put("Useridnumber", getIntent().getStringExtra("idNumber"));
        params.put("Worknumber", getIntent().getStringExtra("workNumber"));
